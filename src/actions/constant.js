...
export const CUSTOMER_CREATE_INITIAL = 'CUSTOMER_CREATE_INITIAL';
export const CUSTOMER_CREATE_SUBMIT = 'CUSTOMER_CREATE_SUBMIT';
export const CUSTOMER_UPDATE_INITIAL = 'CUSTOMER_UPDATE_INITIAL';
export const CUSTOMER_UPDATE_SUBMIT = 'CUSTOMER_UPDATE_SUBMIT';